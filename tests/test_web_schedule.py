...
def test_anchor_submitted_via_api_is_honored() -> None:
    # The "routes around a pinned 7pm dinner" demo must be reachable over HTTP.
    body = {
        "city": "Tokyo",
        "start_date": "2026-07-01",
        "lodging_name": "Hotel",
    ...
    day_view = resp.json()["day_view"]
    assert "Dinner" in day_view and "19:00" in day_view, "the 7pm anchor must be seated"
